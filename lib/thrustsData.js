...
export const thrusts = [
  ...
  },
  {
    ...
    educationalMaterialsSection: {
      title: 'Educational Materials & Tools',
      description: 'Helping Households Understand Their Indoor Air Quality.',
      resources: [
        {
          title: 'Indoor Air Quality Educational Flyer',
          src: '/images/iaq-flyer-final.png',
          alt: 'Indoor Air Quality Educational Flyer – explaining PM₂.₅, CO₂, and VOC indicators for Healthy Home Intervention Project participants',
          caption: 'Indoor Air Quality Educational Flyer for the Healthy Home Intervention Project',
          downloadHref: '/images/iaq-flyer-final.png'
        }
      ]
    }
  },
