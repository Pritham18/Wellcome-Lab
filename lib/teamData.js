...
By integrating sociological and psychological perspectives, her research interests focuses on human psychology and behavioral factors related to environmental architecture, climate change, and energy use.`,
  ...
  'raghu-manjunatha': {
    slug: 'raghu-manjunatha',
    name: 'Raghu Manjunatha',
    role: 'Research Assistant',
    roleLabel: 'Research Assistant',
    category: 'research-assistants',
    photo: '/images/team/raghu-manjunatha.jpg',
    affiliation: 'Clemson University',
    titles: [
      'Research Assistant',
    ...
    highlights: [
      'Data analytics and AI/ML experience',
      'Climate and energy dataset analysis',
      'Geospatial and research workflow support',
      'Web-based research platform development'
    ],
    bio: `Raghu Manjunatha is a research assistant at Clemson University with experience in data analytics, artificial intelligence, machine learning, NLP, and web-based research systems. He holds an MS in Data Analytics Engineering from George Mason University, where he worked on applied data projects involving geospatial analysis, document intelligence, predictive modeling, and data visualization. His current work focuses on collecting, validating, cleaning, and analyzing climate, energy, and social science datasets to support research on community resilience, energy burden, extreme weather, and infrastructure-related challenges. With a background in AI-assisted data workflows, research documentation, and interactive platform development, Raghu is interested in using data-driven methods to improve decision-making in climate, energy, and public policy research.`,
    externalLink: null,
    badgeColor: '#2e9d8f'
  },
  'pritham-mahajan': {
...
export function getTeamByCategory(category) {
  ...
  // Custom ordering for leadership section
  if (category === 'leadership') {
    const order = ['chien-fei-chen', 'mingzhou-jin', 'bruce-tonn', 'gary-adamkiewicz', 'kristina-kintziger', 'leon-tolbert'];
  ...
  if (category === 'research-assistants') {
    const order = ['yueyang-feng', 'pritham-mahajan', 'fateh-arina', 'raghu-manjunatha'];
    return members.sort((a, b) => {
      const indexA = order.indexOf(a.slug);
      const indexB = order.indexOf(b.slug);
